...
- ✅ **Script files** (`.writekit/scripts/`)
- ✅ **Template files** (`.writekit/templates/`)
- ✅ **Shared memory files** (`.writekit/memory/`) - **⚠️ See warnings below**
...
3. **Some files may be overwritten** - If you already have Spec Kit files (`.claude/`, `.writekit/`, etc.), they'll be replaced with the new versions
...
- Scripts in `.writekit/scripts/`
- Templates in `.writekit/templates/`
- Memory files in `.writekit/memory/` (including constitution)
...
3. **Check you're in the correct directory** where you ran `writekit init`
...
- **Check documentation:** Visit [hskksk.github.io/spec-writing-kit](https://hskksk.github.io/spec-writing-kit/) for updated guides
