...
Add the new agent to the `AGENT_CONFIG` dictionary in `src/writekit_cli/__init__.py`. This is the **single source of truth** for all agent metadata:
...
2. **CLI test**: Test `writekit init --ai <agent>` command
