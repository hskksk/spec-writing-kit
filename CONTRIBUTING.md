...
1. Make sure the CLI works on your machine: `uv run writekit --help`
...
Running `uv run writekit init` pulls released packages, which won’t include your local changes.  
